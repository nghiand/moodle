...
/**
 * Defines restore_qtype_plugin_using_extra_fields_methods class
 *
 * @package    core_backup
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_plugin_using_extra_fields_methods extends restore_qtype_plugin {
    /**
    ...
    /**
     * Describes, whether the question has been created by restore
     * @var bool
     */
     ...
     *
     * @param array $data question answer data
     */
    ...
    public function really_process_extra_question_fields($data) {
        ...
        $this->questioncreated = $this->get_mappingid('question_created', $oldquestionid) ? true : false;
